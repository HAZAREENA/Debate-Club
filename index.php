...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#about" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw w3-margin-right"></i>ABOUT DEBATE CLUB</a>
  ...
  <div class="w3-panel w3-large">
     ...
     <p>Find us here:</p>
 <img src="photo/fb.jpg" style="width:11%;" class="w3-round">
 <img src="photo/instagram.jpg" style="width:11%;" class="w3-round">
 <img src="photo/whatsapp.jpg" style="width:16%;" class="w3-round">
  </div>
</nav>
...
<!-- First Photo Grid-->
 ...
 <div class="w3-quarter">
     ...
     <div class="w3-quarter">
      <img src="photo/photo10.jpg" alt="Pasta and Wine" style="width:100%">
      <h3>Gabriel</h3>
